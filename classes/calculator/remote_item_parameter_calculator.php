...
namespace catquizcentralhub_host\calculator;

use catquizcentralhub_host\repository\remote_responses;
...
class remote_item_parameter_calculator {
    ...
    public function calculate_for_scale(int $scaleid, ?int $userid = null) {
        ...
        try {
            ...
            if ($newresponses == 0) {
                ...
                $event = calculation_skipped::create([
                    ...
                    'other' => [
                        ...
                        'reason' => get_string('nonewresponses', 'catquizcentralhub_client'),
                    ],
                ]);
                $event->trigger();
                return false;
            ...
            $responses = $repo->get_for_scale($scale->id, $scale->contextid);
            ...
            $repo->mark_processed($catscaleids, $scale->contextid);
